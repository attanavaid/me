  ...
  return (
    <section id="languages">
      ...
      <div className="container languages__container">
        <div
          className="h-48 md:h-40 lg:h-32 wow fadeIn"
          aria-live="polite"
          aria-atomic="true"
        >
          <Typist
            ...
            {languagesData.map((node, index) => {
              return (
                <div key={index}>
                  ...
                  <span className="italic font-thin">{node.translation}</span>
                  <Typist.Backspace
        ...
        <div className="languageBox mt-12 flex flex-wrap">
          <ol className="text-xl" aria-label="Languages I speak">
            ...
            {languagesData.map((node, index) => {
              return (
                <li key={index} className="language text-xl ml-8">
                  {index + 1}.{" "}
                  <strong id="languageText">{node.language}</strong>{" "}
                  <i id="langLevel">({node.level})</i>
                </li>
              );
            })}
          </ol>
